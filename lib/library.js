...
var _erf = __webpack_require__(0);
...
exports.transport1D = exports.mounding = exports.numInt = exports.erfc = exports.erf = undefined;

var _erf = __webpack_require__(0);

var _erf2 = _interopRequireDefault(_erf);

var _erfc = __webpack_require__(1);

var _erfc2 = _interopRequireDefault(_erfc);

var _mounding = __webpack_require__(4);

var mounding = _interopRequireWildcard(_mounding);

var _transport1D = __webpack_require__(5);

var transport1D = _interopRequireWildcard(_transport1D);

var _numericallyIntegrate = __webpack_require__(2);
...
exports.numInt = _numericallyIntegrate2.default;
...
function S(alpha, beta) {
    var func = function func(tau) {
        if (tau !== 0) {
            ...
            return (0, _erf2.default)(alpha / sqrtTau) * (0, _erf2.default)(beta / sqrtTau);
        }

        return 0;
    };

    return (0, _numericallyIntegrate2.default)(0, 1, 0.001, func);
}
...
function calculateC(x, t, K, I, ne, alphaL, Kd) {
    ...
    var term1 = (0, _erfc2.default)((x - vx * t / R) / (2 * Math.sqrt(DL * t / R)));
    var term2 = (0, _erfc2.default)((x + vx * t / R) / (2 * Math.sqrt(DL * t / R)));
